      ...
      <main className="flex flex-col xl:flex-row pt-24 px-6 gap-8">
        ...
        <aside className="xl:w-[35%] bg-white rounded-xl shadow-lg p-8 flex flex-col gap-4 h-fit">
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-col gap-4 h-64 overflow-y-auto border rounded-lg p-3 bg-gray-50">
              {anotacoes.length === 0 ? (
      ...
      {modalAberto && anotacaoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-lg w-full relative">
            ...
            <h2 className="text-xl font-bold mb-2">{anotacaoModal.titulo}</h2>
            <div className="text-gray-700 whitespace-pre-wrap">{anotacaoModal.conteudo}</div>
          </div>
        </div>
      )}
    </div>
